...
/* 120 */         LoggingEvent event = (LoggingEvent)objectMessage.getObject();
/* 121 */         Logger remoteLogger = Logger.getLogger(event.getLoggerName());
/* 122 */         remoteLogger.callAppenders(event);
/*     */       } else {
/* 124 */         logger.warn("Received message is of type " + message.getJMSType() + ", was expecting ObjectMessage.");
/*     */       }
/*     */     }
/*     */     catch (JMSException jmse) {
/* 128 */       logger.error("Exception thrown while processing incoming message.", jmse);
/*     */     }
/*     */   }
/*     */ 
...
/* 145 */     System.err.println("Usage: java " + JMSSink.class.getName() + " TopicConnectionFactoryBindingName TopicBindingName username password configFile");
/*     */ 
/* 147 */     System.exit(1);
/*     */   }
/*     */ }

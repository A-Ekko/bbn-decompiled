...
/*     */ 
/* 346 */     this.mFilteredEvents = ((EventDetails[])(EventDetails[])filtered.toArray(EMPTY_LIST));
/*     */ 
...
/*     */         {
/*     */         }
/*  85 */         synchronized (this.this$0.mLock) {
/*  86 */           if (this.this$0.mPaused)
/*     */           {
/*     */             continue;
/*     */           }
/*  90 */           boolean toHead = true;
/*  91 */           boolean needUpdate = false;
/*  92 */           Iterator it = this.this$0.mPendingEvents.iterator();
/*  93 */           while (it.hasNext()) {
/*  94 */             EventDetails event = (EventDetails)it.next();
/*  95 */             this.this$0.mAllEvents.add(event);
/*  96 */             toHead = (toHead) && (event == this.this$0.mAllEvents.first());
/*  97 */             needUpdate = (needUpdate) || (this.this$0.matchFilter(event));
/*     */           }
/*  99 */           this.this$0.mPendingEvents.clear();
/*     */ 
/* 101 */           if (needUpdate)
/* 102 */             this.this$0.updateFilteredEvents(toHead);
/*     */         }
/*     */       }
/*     */     }
/*     */ 

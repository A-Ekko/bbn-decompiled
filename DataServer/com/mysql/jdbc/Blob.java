...
/*     */   {
/* 117 */     if (pos < 1L) {
/* 118 */       throw new SQLException(Messages.getString("Blob.2"), "S1009");
/*     */     }
/*     */ 
...
/* 176 */       throw new SQLException(Messages.getString("Blob.0"), "S1009");
/*     */     }
/*     */ 
...
/* 207 */       throw new SQLException(Messages.getString("Blob.1"), "S1000");
/*     */     }
/*     */     finally {
/*     */       try {
/* 211 */         bytesOut.close();
